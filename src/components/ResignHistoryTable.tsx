              ...
              return (
                <tr key={item.id} className="hover:bg-white/5 transition-colors group relative">
                  ...
                  <td className="px-6 py-5 text-right relative">
                    ...
                    {openMenuId === item.id && (
                      <div className="absolute right-8 top-10 z-50 bg-surface-container-highest backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl shadow-black/80 py-2 min-w-[200px] flex flex-col text-left animate-in fade-in slide-in-from-top-2">
