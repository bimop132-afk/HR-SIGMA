      ...
      <div className="flex justify-between items-start">
        ...
        {menuOpen && (
          <>
            ...
            <div className="absolute right-5 top-14 z-20 bg-surface-container-highest backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl shadow-black/80 py-2 min-w-[160px] overflow-hidden animate-pop-in">
